    ...
    <div className="credit">
      ...
      <div style={{ width: '100%', display: 'flex', alignItems: 'center', overflow: 'hidden' }}>
        <a
          ...
          target="_blank"
          rel="noreferrer"
          aria-label={getAriaLabel('buymeacoffee_link')}>
          <img
      ...
      <div className={'credit-icons'}>
        <a
          ...
          target="_blank"
          rel="noreferrer"
          aria-label={getAriaLabel('developer_github')}>
          <svg
            role="img"
            aria-hidden="true"
            viewBox="0 0 24 24"
        ...
        <a
          href="https://velog.io/@shipfriend/posts"
          target="_blank"
          rel="noreferrer"
          aria-label={getAriaLabel('developer_velog')}>
          <svg
            width={24}
            height={24}
            fill={'#20C997'}
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          aria-label={getAriaLabel('developer_blog')}
          className={'credit-icon'}>
          <img src={blogIcon} alt="" role="presentation" />
        </a>
      </div>
      <div>
